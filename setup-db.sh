...
ESCAPED_WIN_JAVA_HOME=$(echo "$WIN_JAVA_HOME" | sed 's/\\/\\\\/g')
export JAVA_HOME=$ESCAPED_WIN_JAVA_HOME
...
CWD=$(pwd)
PRODUCT_FOLDER=$IDEMPIERE_SOURCE_FOLDER/org.idempiere.p2/target/products/org.adempiere.server.product/win32/win32/x86_64
cd $PRODUCT_FOLDER
